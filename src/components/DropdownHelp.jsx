          ...
          <ul>
            <li>
              <Link
                ...
                to="https://www.tarc.edu.my/dsa/a/student-career-development-center/faq/"
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
            ...
            <li>
              <Link
                className="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3"
                to="https://sites.google.com/tarc.edu.my/scdcstudents/home"
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <svg className="w-3 h-3 fill-current text-indigo-300 dark:text-indigo-500 shrink-0 mr-2" viewBox="0 0 12 12">
            ...
            <li>
              <Link
                className="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3"
                to="https://www.tarc.edu.my/dsa/a/student-career-development-center/contact-information/"
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <svg
            ...
            <li>
              <Link
                className="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3"
                to="https://sites.google.com/tarc.edu.my/scdccompanycentre/services"
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <svg className="w-3 h-3 fill-current text-indigo-300 dark:text-indigo-500 shrink-0 mr-2" viewBox="0 0 12 12">
